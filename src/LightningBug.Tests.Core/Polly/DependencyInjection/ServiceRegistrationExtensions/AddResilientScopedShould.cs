...
{
    public class AddResilientScopedShould
    {
        ...
        private void Registers(Expression<Func<ServiceDescriptor, bool>> check)
        {
            ...
            serviceCollection.Object.AddResilientScoped<IService, Service>();
        ...
        [Fact]
        public void RegisterItScoped()
        {
            Registers(sd => sd.Lifetime == ServiceLifetime.Scoped);
        }
